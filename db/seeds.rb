...
Note.create([
        {
                ...
                :languages => [Language.find_by_name('Norsk')],
                :item => '13',
                :title => 'Herre, vår Gud',
                :voice => 'SATB',
                :count_originals => '0',
        ...
        },
        {
                ...
                :languages => [Language.find_by_name('Latin')],
        ...
        },
        {
                ...
                :instrument => 'A capella',
                :languages => [Language.find_by_name('Engelsk')],
        ...
        },
        {
                ...
                :instrument => 'A capella',
                :languages => [Language.find_by_name('Italiensk')],
                :item => '469',
                :title => 'Santa Lucia',
                :voice => 'SAB',
                :count_originals => '0',
        ...
        },
        {
                ...
                :instrument => 'A capella',
                :languages => [Language.find_by_name('Svensk')],
        ...
        },
        {
                ...
                :genre => Genre.find_by_name('Motett'),
                :instrument => 'A capella',
                :languages => [Language.find_by_name('Tysk')],
                :item => '596',
        ...
        },
        {
                ...
                :genre => Genre.find_by_name('Motett'),
                :instrument => 'A capella',
                :languages => [Language.find_by_name('Finsk')],
        ...
        },
        {
                ...
                :genre => Genre.find_by_name('Motett'),
                :instrument => 'A capella',
                :languages => [Language.find_by_name('Islandsk')],
        ...
        },
        {
                ...
                :genre => Genre.find_by_name('Liturgi'),
                :instrument => 'A capella',
                :languages => [Language.find_by_name('Gresk')],
        ...
        },
        {
                ...
                :genre => Genre.find_by_name('Motett'),
                :instrument => 'A capella',
                :languages => [Language.find_by_name('Dansk')],
        ...
        },
        {
                ...
                :genre => Genre.find_by_name('Motett'),
                :instrument => 'Orgel, Tromme',
                :languages => [Language.find_by_name('Fransk')],
